          ...
          <div className="flex items-center justify-between py-3 md:py-2">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                {displayItemCount > 0 && (
                  <span className="absolute -top-1 -right-1.5 w-5 h-5 flex items-center justify-center text-xs font-bold text-white bg-[#4E1D4D] rounded-full ring-2 ring-stone-50">
                    {displayItemCount}
                  </span>
                )}
              </div>
